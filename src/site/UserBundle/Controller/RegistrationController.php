...
class RegistrationController extends BaseController {
    ...
    public function checkEmailAction() {
        ...
        $data['user'] = $this->container->get('fos_user.user_manager')->findUserByEmail($email);
    ...
    public function confirmed_popupAction() {
        ...
        return $this->container->get('templating')->renderResponse('FOSUserBundle:Registration:confirmed_popup.html.twig', array(
            'user' => $user,
        ));
    }
